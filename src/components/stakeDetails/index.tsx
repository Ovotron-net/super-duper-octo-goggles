...
const StakingDetails = () => {
    ...
    const [mode, setMode] = useState<"Commit" | "Withdraw">("Withdraw");
    ...
    const [startTimeDate, setStartTimeDate] = useState<Number>();
    const [endTimeDate, setEndTimeDate] = useState<Number>();
    ...
    const [isStakingReady, setIsStakingReady] = useState<Boolean>(false);
    ...
    const [userMblkBalance, setUserMblkBalance] = useState<String>();
    ...
    const changeMode = (newMode: "Commit" | "Withdraw") => {
        setMode(newMode);
    };
